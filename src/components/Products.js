...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2">
    <a href="#">
        <img class="p-8 rounded-t-lg" src={omr} alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-white bg-omronBlue hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">სრულად</a>
        </div>
    </div>
</div>
    ...
    return ( 
        <div className="flex flex-wrap justify-center">
            <div className='drawer w-2/6 flex flex-col bg-omronBlue text-white items-start lg:w-1/6' >
